...
class OvercookedEnv(object):
    ...
    def step(self, joint_action, agent_roles = None, joint_agent_action_info=None, display_phi=False):
        ...
        next_state, mdp_infos = self.mdp.get_state_transition(self.state, joint_action, agent_roles, display_phi, self.mp)
    ...
    def _prepare_info_dict(self, joint_agent_action_info, mdp_infos):
        ...
        env_info["role_r_by_agent"] = mdp_infos["role_reward_by_agent"]
